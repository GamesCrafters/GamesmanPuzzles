...
# Template for Tiltago obtained from Towers of Hanoi file
...
class Tiltago(ServerPuzzle):
    ...
    def __init__(self,  variantid=None, variant=None):
        """Returns the starting position of Tiltago based on variant first, then 
    ...
    def fromString(cls, variant_id, position_str : str):
        ...
        Example: positionid="6-1-0" for Tiltago creates a Tiltago puzzle
    ...
    def __repr__(self):
        ...
        raise NotImplementedError
        return "Tiltago(board={})".format(self.toString())
    ...
    def doMove(self, move):
        ...
        newPuzzle = Tiltago(variantid=self.variant)
        rods = self.rods.copy()
    ...
    def generateMoves(self, movetype="all"):
        ...
        NOTE: For Tiltago, all moves are bidirectional, so movetype doens't matter
    ...
    def generateStartPosition(cls, variantid, variant=None):
        ...
        return Tiltago(variantid, variant)
