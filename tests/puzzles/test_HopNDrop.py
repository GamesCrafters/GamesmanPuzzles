...
from puzzlesolver.puzzles import HopNDrop
...
# Unit testing
def testHash():
    puzzle0 = HopNDrop.deserialize('1_11_010_1111_01101_')
    puzzle1 = HopNDrop.deserialize('1_11_010_1111_01101_')
    puzzle2 = HopNDrop.deserialize('1_11_100_0011_11110_')
    puzzle3 = HopNDrop.deserialize('0_10_100_1101_10111_')
